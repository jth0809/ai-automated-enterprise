...
- [ ] **Step 1: 생산 개수·ESA·P1 재생 기대값을 먼저 테스트에 쓴다**
...
- [ ] **Step 2: 새 테스트가 기존 데이터에서 실패하는지 확인한다**
...
- [ ] **Step 3: 공식 페이지 지문이 검토 시점 값과 일치하는지 확인한다**
...
NASA 30284d97e345d65166fbcae1634f9fdf77730076c9f8a49745e228756d0651f3 327,218 bytes
```

도구 출력에는 원문이 없어야 한다. 페이지가 갱신돼 지문만 달라졌다면 실제
페이지에서 같은 사실을 재확인하고 새 지문만 사용한다.

- [ ] **Step 4: 생산 후보 정확 개수를 212로 올린다**
...
- [ ] **Step 5: ESA 메타데이터와 후보 두 행을 추가한다**
...
- [ ] **Step 7: 집중 테스트와 정적 코퍼스 검증을 통과시킨다**
...
- [ ] **Step 1: 최종 개수·분포·파일 크기·SHA-256을 산출한다**
...
- [ ] **Step 4: 전체 백엔드와 정책 검증을 fresh 실행한다**
...
- [ ] **Step 5: 실행계획과 진행 원장에 실제 검증 결과를 기록한다**
